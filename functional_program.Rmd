...
Before getting too wild and crazy, let's start out with a very simple coin toss function. This function will be somewhat redundant, but it's sole purpose is only to demonstrate the basic logic of functional programming.
